<?php
//session_start(); // (1) - Sesi dimulai, tapi di-comment, mungkin karena sudah dimulai di skrip lain atau belum diperlukan.
if (!isset($_SESSION['apriori_parfum_id'])) {
    header("location:index.php?menu=forbidden");
}

include_once "database.php"; // (2) - Memasukkan file database.php, pastikan path dan file sudah benar.
include_once "fungsi.php"; // (3) - Memasukkan file fungsi.php, pastikan path dan file sudah benar.
include_once "import/excel_reader2.php"; // (4) - Memasukkan file excel_reader2.php, pastikan path dan file sudah benar.
?>
